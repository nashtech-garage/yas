...
update product set is_active = true where id = 3;
update product set is_active = true where id = 4;
update product set is_active = true where id = 5;
update product set is_active = true where id = 6;
update product set is_active = true where id = 7;
update product set is_active = true where id = 8;
