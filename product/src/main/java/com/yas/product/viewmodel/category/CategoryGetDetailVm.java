...
public record CategoryGetDetailVm(long Id, String name, String slug, String description, long parentId, String metaKeywords, String metaDescription, short displayOrder, Boolean isPublish, ImageVm categoryImage) {
