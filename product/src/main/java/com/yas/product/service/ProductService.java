...
import com.yas.product.viewmodel.product.ProductVariationSaveVm;
...
public class ProductService {
    ...
    private Map<Long, ProductOption> getProductOptionByIdMap(List<ProductOptionValueSaveVm> optionValueVms) {
