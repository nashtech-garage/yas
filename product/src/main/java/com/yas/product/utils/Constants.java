...
public final class Constants {
	public final class ERROR_CODE {
		...
		public static final String SLUG_ALREADY_EXITED = "SLUG_ALREADY_EXISTED";
		public static final String SKU_ALREADY_EXITED = "SKU_ALREADY_EXISTED";
		public static final String GTIN_ALREADY_EXITED = "GTIN_ALREADY_EXISTED";
	}
}
