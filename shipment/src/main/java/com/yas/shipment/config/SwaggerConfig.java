package com.yas.shipment.config;
...
@OpenAPIDefinition(info = @Info(title = "Shipment Service API", description = "Shipment API documentation", version = "1.0"), security = @SecurityRequirement(name = "oauth2_bearer"),
