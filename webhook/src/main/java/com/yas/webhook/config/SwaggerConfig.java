...
@OpenAPIDefinition(info = @Info(title = "Webhook Service API", description = "Webhook API documentation", version = "1.0"), security = @SecurityRequirement(name = "oauth2_bearer"),
