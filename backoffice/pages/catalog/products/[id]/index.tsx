...
import EditSEOOfProduct from '../[id]/editSEOOfProduct';
import { useRouter } from 'next/router';
import { Product } from '../../../../modules/catalog/models/Product';
import { getProduct } from '../../../../modules/catalog/services/ProductService';
import EditCategoryOfProduct from './editCategoryOfProduct';
        ...
        <div className="col-md-12">
          ...
          <div className="isolate-scope" style={{ marginTop: '50px' }}>
            <Tabs activeKey={tabKey} onSelect={(e: any) => setTabKey(e)}>
              ...
              <Tab eventKey="two" title="Product Variations">
                <h2>product Variations</h2>
              </Tab>
              <Tab eventKey="three" title="Product Attributes">
                <ProductAttributes />
              </Tab>
              <Tab eventKey="four" title="Category Mapping">
                <EditCategoryOfProduct />
              </Tab>
              <Tab eventKey="five" title="SEO">
                <EditSEOOfProduct />
              </Tab>
            </Tabs>
          </div>
