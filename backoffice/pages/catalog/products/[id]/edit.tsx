...
const ProductEdit: NextPage = () => {
  ...
  const [productImageMediaUrls, setproductImageMediaUrls] =
    useState<string[]>();
          ...
          <div className="col-md-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-3">
                ...
                <Link
                  href={`/catalog/products/${product.id}/productAttributes`}
                >
                  <button
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className={`form-control ${
                    errors.metaKeyword ? "border-danger" : ""
                  }`}
                  type="text"
                  id="meta-keyword"
                  name="metaKeyword"
