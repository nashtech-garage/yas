...
import { FromProductTemplate, ProductAttributeOfTemplate } from '@catalogModels/FormProductTemplate';
import {
...
const ProductTemplateCreate = () => {
    ...
    const handleSubmitProductAttribute = async (event: FromProductTemplate) => {
            ...
            <form onSubmit={handleSubmit(handleSubmitProductAttribute)}>
              <div className="d-flex flex-column">
                ...
                <div className="mb-5 d-flex align-items-center">
                  ...
                  {
                    checkHidden ? 
                    <button className="form-control w-50 btn btn-primary"
                    ...
                    :
                    <button  className="form-control w-50 btn btn-secondary" style={{ height: 'auto', width: 'auto' }} >
                      More features
                    </button>
                  }
                </div>
