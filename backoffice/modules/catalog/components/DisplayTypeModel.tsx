...
type DisplayTypeModalProps = {
    ...
    productOptionValuePost: { productOptionId?: number; value: { [key: string]: string; }; displayType?: string; displayOrder?: number }[];
                                                ...
                                                <Col sm={8}>
                                                    <Row className='d-inline-flex justify-content-start'>
                                                        <Col className="d-flex align-items-center m-0 p-0 col-3">
                                                            <Form.Control type="color" className='m-0 p-1 w-100' value={value} onChange={(event) => handleColorChange(event as React.ChangeEvent<HTMLInputElement>, key)} />
                                                        </Col>
                                                        <Col className="d-flex align-items-center">
                                                            <Form.Control type="text" value={value} onChange={(event) => handleColorChange(event as React.ChangeEvent<HTMLInputElement>, key)} placeholder="#000000" />
                                                        </Col>
                                                    </Row>
                                                </Col>
                                            </Col>
