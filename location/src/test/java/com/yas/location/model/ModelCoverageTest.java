...
class ModelCoverageTest {
    ...
    void testAllModelsAndViewModels() throws Exception {
        ...
        provider.addIncludeFilter(new RegexPatternTypeFilter(Pattern.compile("com\\.yas\\.location\\.(model|viewmodel)\\..*")));
        
        Set<BeanDefinition> beans = provider.findCandidateComponents("com.yas.location");
