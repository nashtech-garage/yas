...
class OrderStatusConsumerTest {
    ...
    @Test
    void testListen_whenPaymentMethodIdIsNotFound_shouldNotSave() {
        ...
        assertThat(badRequestException.getMessage())
            .isEqualTo("Failed to process checkout event for ID 123");
        ...
        assertThat(actual.getLastError())
            .isEqualTo("{\"errorCode\":\"PAYMENT_CREATED_FAILED\","
                + "\"message\":\"Payment method id is not existed in Checkout 123\"}");
    }
