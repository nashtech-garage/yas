...
public final class Constants {
    public final class ErrorCode {
        ...
        public static final String PAYMENT_METHOD_NOT_EXISTED = "PAYMENT_METHOD_NOT_EXISTED";
    ...
    public final class Column {
        ...
        public static final String CHECKOUT_PAYMENT_METHOD_ID_COLUMN = "payment_method_id";
        public static final String CHECKOUT_TOTAL_AMOUNT_COLUMN = "total_amount";
