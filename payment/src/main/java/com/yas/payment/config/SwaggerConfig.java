...
@OpenAPIDefinition(info = @Info(title = "Payment Service API", description = "Payment API documentation", version = "1.0"), security = @SecurityRequirement(name = "oauth2_bearer"),
