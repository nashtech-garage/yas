...
INSERT INTO product (id,description,gtin,has_options,is_allowed_to_order,is_featured,is_published,is_visible_individually,meta_description,meta_keyword,meta_title,"name",price,short_description,sku,slug,specification,thumbnail_media_id,brand_id,stock_tracking_enabled,tax_included,stock_quantity,tax_class_id) VALUES
