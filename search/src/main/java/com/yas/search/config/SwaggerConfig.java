...
@OpenAPIDefinition(info = @Info(title = "Location Service API", description = "Location API documentation", version = "1.0"), security = @SecurityRequirement(name = "oauth2_bearer"),
