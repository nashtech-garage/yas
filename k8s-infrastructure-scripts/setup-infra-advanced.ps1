Write-Host "--- CÀI ĐẶT HẠ TẦNG PHẦN NÂNG CAO (GITOPS) ---"
...
Write-Host "2. Cài đặt PostgreSQL (Dùng chung)..."
...
Write-Host "5. Cài đặt Elasticsearch (Dùng chung)..."
...
Write-Host "6. Cài đặt Keycloak CRDs (Dùng chung)..."
...
Write-Host "7. Cài đặt yas-configuration & Keycloak cho môi trường DEV..."
...
Write-Host "8. Cài đặt yas-configuration & Keycloak cho môi trường STAGING..."
...
Write-Host "HOÀN TẤT! Đợi các Pod chạy xong (kubectl get pods -A) rồi bạn hãy chạy script cài đặt ArgoCD."
