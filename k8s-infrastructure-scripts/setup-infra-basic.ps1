Write-Host "--- SETUP BASIC INFRASTRUCTURE ---"
...
Write-Host "2. Installing yas-configuration (Namespace: yas)..."
...
Write-Host "4. Installing Keycloak (Namespace: yas)..."
...
Write-Host "DONE! Wait for all Pods to be running (kubectl get pods -A), then you can run the developer-build Github Actions workflow."
