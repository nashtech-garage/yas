...
@OpenAPIDefinition(info = @Info(title = "Promotion Service API", description = "Promotion API documentation", version = "1.0"), security = @SecurityRequirement(name = "oauth2_bearer"),
