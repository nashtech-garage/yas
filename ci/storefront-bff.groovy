/**
 * Storefront-BFF Service CI — loaded and executed by the master Jenkinsfile.
 *
 * Tech stack : Java / Maven (multi-module, uses -pl storefront-bff -am)
...
def call() {
    ...
    try {
            ...
            try {
                try {
                    withCredentials([string(credentialsId: 'nvd-api-key', variable: 'NVD_API_KEY')]) {
                        sh '''
                            mvn -pl storefront-bff -am org.owasp:dependency-check-maven:check \
                              -DfailBuildOnCVSS=7 \
                ...
                publishHTML target: [
                    ...
                    keepAll              : true,
                    reportDir            : 'storefront-bff/target',
        ...
        echo "Storefront-BFF service build completed successfully"
    } catch (Exception e) {
        echo "Storefront-BFF service build failed"
        throw e
    }
}
